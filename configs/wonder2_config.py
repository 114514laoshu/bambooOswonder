# ============================================================================
# Module: configs/wonder2_config.py
# 模块：configs/wonder2_config.py
# Description: Bamboo OS Wonder 2.0 Configuration
# 描述：Bamboo OS Wonder 2.0 配置文件
# ============================================================================
...
VERSION = "2.0.0"
RELEASE = "2026.07"
TARGET_NAME = "Bamboo OS Wonder 2.0"

# ============================================================================
# Kernel Configuration / 内核配置
# ============================================================================
KERNEL_CONFIG = {
    "name": "Bamboo OS Wonder 2.0",
    "arch": "x86_64",
    "multiboot": 2,                     # Multiboot2
    "direct_boot": True,                # Support direct boot
...
BOOT_CONFIG = {
    ...
    "default": "bamboo-os",
    "menu_entries": [
        {"title": "Bamboo OS Wonder 2.0", "kernel": "wonder2.elf", "args": ""},
        {"title": "Wonder 2.0 (Safe Mode)", "kernel": "wonder2.elf", "args": "safemode"},
        {"title": "Memory Test", "kernel": "wonder2.elf", "args": "memtest"},
    ]
}
...
OUTPUT_CONFIG = {
    "elf": "wonder2.elf",
    "bin": "wonder2.bin",
    "iso": "bamboo-wonder2.iso",
    "initrd": "initrd.tar",
    "disk_image": "disk.img",
    "output_dir": "build/wonder2/",
}
